...
namespace Lab13
{
    class SDALog
    {
        private static string path = @"D:\labs_3sem\OOP\lab13\sdalogfile.txt";
    ...
    class SDAFileInfo
    {
        ...
        {
            string path = $@"D:\labs_3sem\OOP\lab13\{filename}";
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SDALog.Read();
            SDALog.Search("info");
            //SDADiskInfo.FreeSpace("C");
            //SDADiskInfo.FileSystem("C");
            //SDADiskInfo.DrivesInfo();
            SDAFileInfo.FileInfo("file1.txt");
            SDADirInfo.DirInfo(@"D:\labs_3sem\OOP\lab13\");
            SDAFileManager.CreateDir(@"D:\labs_3sem\OOP\lab13\SDAInspect1");
            //SDAFileManager.CreateFile(@"D:\Git\Labs\OOP\Lab13\sdadirinfo.txt", "info");
            SDAFileManager.CopyRenameWrite(@"D:\labs_3sem\OOP\lab13\sdadirinfo.txt", @"D:\labs_3sem\OOP\lab13\dir\sdadirinfoNew.txt");
            SDAFileManager.CreateDir(@"D:\labs_3sem\OOP\lab13\SDAFiles");
            SDAFileManager.CopyExt(@"D:\labs_3sem\OOP\lab13\", @"D:\labs_3sem\OOP\lab13\SDAFiles\");
            SDAFileManager.MoveDirectory(@"D:\labs_3sem\OOP\lab13\SDAFiles", @"D:\labs_3sem\OOP\lab13\SDAInspect\");
            string sourceFolder = @"D:\labs_3sem\OOP\lab13\SDAInspect"; // исходная папка
            string zipFile = @"D:\labs_3sem\OOP\lab13\zip.zip"; // сжатый файл
            string targetFolder = @"D:\labs_3sem\OOP\lab13\.vs"; // папка, куда распаковывается файл
